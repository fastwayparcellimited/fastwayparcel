...
window.onload = function() {
  ...
  if (isIE() || window.matchMedia('(max-width: 992px)').matches == true) {
    ...
    if (langCheck()) {
      if (enviromentCheck()) {
        el.setAttribute('data-prop-brand-uri', 'Fastway Parcel-DEV-FR');
      } else {
        el.setAttribute('data-prop-brand-uri', 'Fastway Parcel-PROD-FR');
      }
    } else {
      if (enviromentCheck()) {
        el.setAttribute('data-prop-brand-uri', 'Fastway Parcel-DEV');
      } else {
        el.setAttribute('data-prop-brand-uri', 'Fastway Parcel-PROD');
      }
    }
...
function openChatbot(parameter) {
  ...
  if (isIE() || window.matchMedia('(max-width: 992px)').matches == true) {
    ...
    if (langCheck()) {
      ...
      if (enviromentCheck()) {
        dropinSrc = "https://t.virtualchatpurolator.com/#/Fastway Parcel-DEV-FR"+param;
      } else {
        dropinSrc = "https://prod.virtualchatpurolator.com/#/Fastway Parcel-PROD-FR"+param;
      }
    } else {
      dropinTitle = "Puro Virtual Assistant";
      if (enviromentCheck()) {
        dropinSrc = "https://t.virtualchatpurolator.com/#/Fastway Parcel-DEV"+param;
      } else {
        dropinSrc = "https://prod.virtualchatpurolator.com/#/Fastway Parcel-PROD"+param;
      }
    }
